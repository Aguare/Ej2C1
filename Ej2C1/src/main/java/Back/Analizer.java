...
// source: C:/Users/Henry/Documents/GitHub/Ej2C1/Ej2C1/src/main/Resources/Lex.flex
...
public class Analizer {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\60\0\12\1\7\0\32\2\6\0\32\2\u0185\0";
   ...
   */
  public Analizer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 4: break;
          case 2:
            { addTokenList(yyline,yycolumn,yytext());
            }
            // fall through
          case 5: break;
          case 3:
